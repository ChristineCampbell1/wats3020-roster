...
addStudent() {
    let name = prompt("Enter student full name:","Christine Campbell");
    let email = prompt("Enter student email: ","campbellchr1@seattleu.edu");
...
setTeacher() {
    ...
    let email = prompt("Enter teacher email: ", "asplunda@seattleu.edu");
